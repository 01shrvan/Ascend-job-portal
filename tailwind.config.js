  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Custom colors for the accordion
        accordion: {
          background: "hsl(210, 50%, 96%)", // Light background for accordion items
          foreground: "hsl(210, 20%, 20%)", // Dark text color for accordion items
        },
      },
      keyframes: {
        "accordion-down": {
